...
| `actionvalue`  | `actionvalue`  | Value of the action                           | `boolean`               | `true`    |
...
| `variant`      | `variant`      | Variant of the card select                    | `"checkbox" \| "radio"` | `'radio'` |
...
graph TD;
  ...
  style nk-card-select-single fill:#f9f,stroke:#333,stroke-width:4px
```
