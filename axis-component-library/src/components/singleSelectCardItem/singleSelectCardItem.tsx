...
@Component({
  tag: 'nk-card-select-single',
  styleUrl: 'singleSelectCardItem.css',
  shadow: true,
})
export class SingleSelectCardItem {
  /**
   * Variant of the card select
   */
  @Prop() variant: CardSelectVariant = 'radio';
  /**
   * Url of the image
   */
